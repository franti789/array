...
int *resizeArray(int *array, int oldSize, int newSize) {
    ...
    if (newArray == NULL) {
        ...
        return array; // Zwracamy oryginalną tablicę w przypadku niepowodzenia realokacji
    } else {
        if (newSize > oldSize) {
            // Jeśli nowy rozmiar jest większy, wypełniamy dodatkową część nowej tablicy zerami
...
int main() {
    ...
    // Alokacja pamięci dla tablicy dynamicznej
